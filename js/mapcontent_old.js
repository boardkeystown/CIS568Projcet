...
/*
            ...
            //get extent of rage of change
            let first = d3.extent(map_csvData_rates, d => d.change_rate_male)[0];
            let last = d3.extent(map_csvData_rates, d => d.change_rate_male)[1];
            ...
            function returnColorBasedOnCode(code) {
                ...
                for (let i = 0; i < map_csvData_rates.length; ++i) {
                    if (code === map_csvData_rates[i].country_code_alpha2) {
                        value = map_csvData_rates[i].change_rate_male;
                        break;
                    }
                }
                return colorScale(value);
